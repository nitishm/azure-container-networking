...
//
// This is effectively a convenience to plug in to the zap constructure machinery. By accepting a URI, we can set up a
...
func (s *Sink) Write(b []byte) (int, error) {
	...
	if err != nil {
		return -1, errors.Wrap(err, "sink failed to decode trace")
	}
	s.cli.Track(t)
	return 0, nil
}
